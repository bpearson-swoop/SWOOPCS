<?php
/**
 * Allow the use of short open tags with echo.
 */

namespace PHP_CodeSniffer\Standards\SWOOP\Sniffs\PHP;

use PHP_CodeSniffer\Files\File;
use PHP_CodeSniffer\Sniffs\Sniff;
use PHP_CodeSniffer\Util\Tokens;

class AllowShortOpenTagWithEchoSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($token['code'] === T_INLINE_HTML) {
            ...
            $echoFound   = strpos($content, '<?=');

            if ($openerFound === false || $echoFound !== false) {
                return;
            }
